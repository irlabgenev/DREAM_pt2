...
setwd("D:/Projects/dream-rnascope/e20220103_MK-lyral_exposure/")

d <- read_tsv("e20220103_MK-lyral_exposure-mustn1.puncta_per_cell.txt")
...
d <- read_tsv("e20220103_MK-lyral_exposure-olfr16.total_int.txt")
...
d <- read_tsv("e20220103_MK-lyral_exposure-olfr16.pixel_per_cell.txt")
...
ggsave(filename = "e20220103_MK-lyral_exposure-measures.pdf", 
       plot = p,
       device = "pdf", 
       units = "cm",
       width = 10, 
