#########################################################################################################################
# Import data set
d <- read.csv(file = "_LOTU_20170801_trans2nonenal.txt", sep="\t",row.names = 1)

# Define Control and Exposed mice
control.mice <- paste0("Che", 83:86)
exposed.mice <- paste0("Che", 91:94)

# Define gene order
gene <- unlist(strsplit("Olfr166	Olfr12	Olfr169	Olfr541	Olfr167	Olfr123	Olfr168	Olfr1414	Olfr309	Olfr1209	Olfr527	Olfr1195	Olfr449	Olfr171	Olfr558	Olfr1032	Olfr711	Olfr1336	Olfr67	Olfr1444	Olfr642	Olfr1243	Olfr1199	Olfr584	Olfr177	Olfr1301	Olfr1348	Olfr535	Olfr24	Olfr1297	Olfr220	Olfr15	Olfr1347	Olfr165	Olfr588.ps1	Olfr734	Olfr1036	Olfr60", split = "\t"))
...
averageDMSO <- colMeans(d[1:4,])

dn <- data.frame(t(apply(d[5:8,], 1, function(x) x/averageDMSO)))
...
library(ggplot2)
ggplot(df.list$Olfr169, aes(Condition, rqCT)) +
...
# minimum and maximum on y axis
ymin <- -3
ymax <- 1

# y labels = 0.2, 0.25, 0.5, 1, 2; ticks = each 0.1 and at 0.25
yaxis_tick <- log(c(0.2, 0.25, seq(0.3, 2, 0.1)), 2)
yaxis_labels <- ifelse(is.element(c(0.2, 0.25, seq(0.3, 2, 0.1)), c(0.25, 0.5, 1, 2)), as.character(c(0.2, 0.25, seq(0.3, 2, 0.1))), "")
...
# y axis
axis(2, at=yaxis_tick, labels=yaxis_labels, las=1)
